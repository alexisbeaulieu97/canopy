...
## What Changes
- **BREAKING**: Add context.Context parameter to WorkspaceFinder interface methods
- **BREAKING**: Update callers (GitService, OrphanService, ExportService) to pass context through
...
- Note: Breaking changes are internal only, no public API impact
